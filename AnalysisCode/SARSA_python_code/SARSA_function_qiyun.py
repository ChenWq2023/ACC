...
# =========================自定义的QQP转换函数===========================================================
def qiyun_softmax_update(x, st_name):
...
def generate_action_stable_TD0(init_lick_Q,init_Nolick_Q,action_len,Alpha,Gamma):
...
# =====================================================================================
        Q = np.array([[lick_q, nolick_q]])
        probs = qiyun_softmax_update(Q, 'stable')
        lick_prob = probs[0, 0]
        nolick_prob = probs[0, 1]
        # print(lick_prob,nolick_prob)
# =========================================================================
...
def generate_action_stable_SARSA(init_lick_Q,init_Nolick_Q,action_len,Alpha,Gamma):
    ...
    for i in range(N):
        # Convert Q-values to probabilities
        lick_prob = qiyun_softmax_update([lick_q, nolick_q],'stable')[0]
        nolick_prob = qiyun_softmax_update([lick_q, nolick_q],'stable')[1]
        ...
        lick_prob_0 = qiyun_softmax_update([lick_q_0, nolick_q_0],'stable')[0]
        nolick_prob_0 = qiyun_softmax_update([lick_q_0, nolick_q_0],'stable')[1]
...
def generate_action_uncertain_TD0(init_lick_Q,init_Nolick_Q,action_len,Alpha,Gamma):
...
# =====================================================================================
        Q = np.array([[lick_q, nolick_q]])
        probs = qiyun_softmax_update(Q, 'uncertain')
        lick_prob = probs[0, 0]
        nolick_prob = probs[0, 1]
        # print(lick_prob,nolick_prob)
# =========================================================================
...
def generate_action_uncertain_SARSA(init_lick_Q,init_Nolick_Q,action_len,Alpha,Gamma):
    ...
    for i in range(N):
        # Convert Q-values to probabilities
        lick_prob = qiyun_softmax_update([lick_q, nolick_q],'uncertain')[0]
        nolick_prob = qiyun_softmax_update([lick_q, nolick_q],'uncertain')[1]
        ...
        if action == 'Lick':
            ...
            nolick_q_0 = nolick_q + alpha * (0 - nolick_q)
        # 通过当前动作及时更新Q值，以便于做出下一次动作的预期近似
        lick_prob_0 = qiyun_softmax_update([lick_q_0, nolick_q_0],'uncertain')[0]
        nolick_prob_0 = qiyun_softmax_update([lick_q_0, nolick_q_0],'uncertain')[1]
...
def generate_action_reverse_SARSA(init_lick_Q,init_Nolick_Q,action_len,Alpha,Gamma):
    ...
    for i in range(N):
        ...
        # ============================================================
        Q = np.array([[lick_q, nolick_q]])
        probs = qiyun_softmax_update(Q,'reverse')
        lick_prob = probs[0, 0]
        nolick_prob = probs[0, 1]
        # print(lick_prob,nolick_prob)
        # ============================================================
        ...
        if action == 'Lick':
            ...
            # new_lick_q = lick_q + alpha * (0 + gamma * (1*lick_prob )- lick_q)
            new_lick_q = lick_q 
            new_nolick_q = nolick_q + alpha * (reward + gamma * next_reward - nolick_q)
...
def generate_action_reverse_TD0(init_lick_Q,init_Nolick_Q,action_len,Alpha,Gamma):
